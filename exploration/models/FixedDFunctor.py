...
class FixedDFunctor(pl.LightningModule):
    def __init__(self, latent_dim=32, learning_rate=0.003, lambda_t=0.01, D_values=None):
        super(FixedDFunctor, self).__init__()
